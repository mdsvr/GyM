...
const exercises = [
  {
    ...
    description: 'Advanced pushing exercise requiring immense shoulder and core strength.',
    sets: 4,
    reps: '10-20 seconds',
    videoId: 'UZ-1jwG7aQ4',
    tips: [
      'Master easier progressions first',
      'Keep arms locked',
      'Protract shoulders',
  ...
  {
    name: 'Back Lever',
    description: 'Impressive gymnastics hold developing back and core strength.',
    sets: 3,
    reps: '5-15 seconds',
    videoId: 'EknM2W58KkI',
    tips: [
  ...
  {
    name: 'Muscle Up',
    description: 'Advanced pulling movement combining pull-up and dip.',
    sets: 3,
    reps: '3-5',
    videoId: 'astSQRh1-i0',
    tips: [
  ...
  {
    name: 'Handstand',
    description: 'Fundamental hand balancing skill requiring strength and balance.',
    sets: 5,
    reps: '30-60 seconds',
    videoId: 'ctunmnwbbSI',
    tips: [
  ...
  {
    name: 'Elbow Lever',
    description: 'Impressive balancing skill great for building towards planche.',
    sets: 4,
    reps: '10-20 seconds',
    videoId: 'hEvYGCrHOgI',
    tips: [
      'Find correct elbow position',
      'Keep body straight',
      'Point toes',
...
export default function CalisthenicsSkillsWorkout() {
    ...
    <div className="py-10">
      ...
      <div className={`rounded-xl p-8 mb-10 relative overflow-hidden ${
        ...
        <div className={`relative z-10 ${
          ...
          <h1 className="text-4xl font-bold mb-4">Calisthenics Skills Training</h1>
          <p className={theme === 'testosterone' ? 'text-blue-200' : 'text-gray-600'}>
            Master impressive calisthenics skills and static holds.
            Build strength, balance, and control through progressive training.
          </p>
        </div>
      ...
      <div className={`mt-10 rounded-xl p-6 shadow-lg ${
        ...
        <ul className={`list-disc list-inside space-y-2 ${
          ...
          <li>Always warm up thoroughly before skill work</li>
          <li>Practice skills when fresh at start of workout</li>
          <li>Focus on quality over quantity</li>
          <li>Progress through variations systematically</li>
          <li>Film yourself to check form and progress</li>
        </ul>
      </div>
    </div>
  );
