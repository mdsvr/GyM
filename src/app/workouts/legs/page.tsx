...
const legExercises: Exercise[] = [
  {
    ...
    sets: 4,
    reps: "15-20",
    instructions: "Stand on band with feet shoulder-width apart, hold handles at shoulders, perform squats while maintaining tension.",
  ...
  },
  {
    ...
    sets: 3,
    reps: "12-15",
    instructions: "Stand on band, hinge at hips while keeping legs straight, focus on hamstrings stretch.",
    equipment: ["Resistance Band"]
  },
  {
    ...
    instructions: "Place band above knees, maintain tension while stepping sideways, keep core engaged.",
    equipment: ["Resistance Band"]
  },
  {
    ...
    sets: 4,
    reps: "20-25",
    instructions: "Stand on band, hold handles at sides, rise up on toes and lower with control.",
    equipment: ["Resistance Band"]
  },
  {
    ...
    sets: 3,
    reps: "15-20",
    instructions: "Lie on back, band above knees, push hips up while keeping tension on band.",
    equipment: ["Resistance Band"]
  }
];
    ...
    <div className="py-10">
      ...
      <div className={`rounded-xl p-8 mb-10 relative overflow-hidden ${
        ...
        <div className={`relative z-10 ${
          ...
          <h1 className="text-4xl font-bold mb-4">Legs Day Workout</h1>
          <p className={theme === 'testosterone' ? 'text-blue-200' : 'text-gray-600'}>
            Build strong, powerful legs with these resistance band exercises.
            Focus on proper form and full range of motion for maximum results.
          </p>
        </div>
      ...
      <div className={`mt-10 rounded-xl p-6 shadow-lg ${
        ...
        <ul className={`list-disc list-inside space-y-2 ${
          ...
          <li>Always warm up with light band work and dynamic stretches</li>
          <li>Keep tension on the band throughout movements</li>
          <li>Focus on mind-muscle connection</li>
          <li>Take shorter rest periods (45-60 seconds) to maintain intensity</li>
          <li>Cool down with static stretches</li>
        </ul>
      </div>
    </div>
  );
